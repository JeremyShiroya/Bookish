...
// Inlined publisher → website map (was previously imported from ../../utils/publisherSites,
// which Nitro's Rollup cache fails to resolve in some dev builds). Fuzzy regex matches
// because publisher fields from Google Books, Open Library etc. vary in capitalisation,
// punctuation and imprint nesting.
...
function resolvePublisherDomain(publisher: string | null | undefined): string | null {
