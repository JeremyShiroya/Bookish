...
describe('responsive mobile component split', () => {
  ...
  test('book form and reader routes have dedicated mobile page components', () => {
    ...
    expect(readerMobile).toContain('reader-mode-toggle')
    expect(readerMobile).toContain('reader-listen-view')
    expect(readerMobile).toContain('ri-headphone-fill')
    expect(readerMobile).toContain('ri-equalizer-line')
    expect(readerMobile).toContain('reader-display-sheet')
    expect(readerMobile).toContain('ReaderPagedEpub')
    expect(readerMobile).toContain('listen-chunk.active')
